package dev.study.paging;

public class PagingBean {
	
	private int totalContent; //총 게시물 수 
	private int nowPage = 1; //현재 페이지 넘버 
	private int numberOfContentPerPage = CommonConstants.CONTENT_NUMBER_PER_PAGE; //한 페이지에서 보여줄 게시물 수 
	private int numberOfPageGroup = CommonConstants.PAGEGROUP_NUMBER_PER_PAGE; //한 페이지 그룹내 페이지 수 
